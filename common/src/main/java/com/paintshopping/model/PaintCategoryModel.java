...
public class PaintCategoryModel {
	private int paintCategoryId;
	private String paintCategoryName;
	private String paintCategoryDesciption;

	public PaintCategoryModel() {
	}

	public PaintCategoryModel(int paintCategoryId, String paintCategoryName, String paintCategoryDesciption) {
